...
Large Language Model (LLM) ChatBOT is my first experiment with LLM Artificial Intelligence (AI). The project is mainly based on [this article](https://medium.com/@daydreamersjp/implementing-locally-hosted-llama2-chat-ui-using-streamlit-53b181651b4e) that I modified to improve some stuff and create a better code base structure. 
...
<video src='https://github.com/sasadangelo/llmchatbot/assets/12810456/0dcfbd51-a2c7-4511-8ada-859864ca9bf5' width=180/>
